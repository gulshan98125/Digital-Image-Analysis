...
img_orig = cv2.imread('../data/' + image[4], 1)

#image = ['Pamela.PNG','random.png','lena.png','test.jpg','Pamela.jpg']
image_orig = cv2.imread('../data/' + image[4],1)
...
cv2.imwrite('../output/output_median_cut/mediancut_original.jpg',image_orig)
...
cv2.imwrite('../output/output_median_cut/mediancut_output.jpg', medImg)
print("Completed Median cut!")
