...
filewa = []
filewa.append(open(DIR + filenames[0] + "-morph-points.txt","w"))
filewa.append(open(DIR + filenames[1] + "-morph-points.txt","w"))

ZOOM=1

images = []
images.append(cv2.imread(DIR + filenames[0], 1))
images.append(cv2.imread(DIR + filenames[1], 1))
...
addBoundaryPoints(images[0],filewa[0],ZOOM)
addBoundaryPoints(images[1],filewa[1],ZOOM)
...
# detect faces in the grayscale image1
